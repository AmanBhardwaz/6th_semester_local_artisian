...
export default function ProductList() {
    ...
    const resetFilters = () => { setSearch(""); setSelectedCategory(""); setSelectedSub(""); setSortBy("newest"); setPriceRange(""); };
                    ...
                    {filtered.map((p: any) => (
                        ...
                        >
                            <div onClick={() => navigate(`/product/${p._id}`)} style={{ cursor: "pointer" }}>
                                <div style={{ height: "190px", overflow: "hidden", backgroundColor: "#f0f0f0" }}>
